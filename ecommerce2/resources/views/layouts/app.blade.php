        ...
        <div class="container x-5">
          ...
          <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link {{Request::is('store')||Request::is('store/pages2')||Request::is('detail/')?'active':''}}" href="{{ url('store') }}">Store</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{Request::is('store')?'active':''}}" href="{{ url('store/earings') }}">Earings</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{Request::is('store')?'active':''}}" href="{{ url('store/rings') }}">Rings</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{Request::is('store')?'active':''}}" href="{{ url('store/necklace') }}">Necklace</a>
              </li>
